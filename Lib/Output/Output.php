...
abstract class Output implements OutputInterface {
   ...
   * {@inheritdoc}
   */
  public function writeln($messages, $type = null, $options = self::OUTPUT_NORMAL) {
   ...
   * {@inheritdoc}
   */
  public function write($messages, $type = null, $newline = false, $options = self::OUTPUT_NORMAL) {
